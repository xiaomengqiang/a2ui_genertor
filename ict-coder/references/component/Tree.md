# Tree
> id: string | component: "Tree" | props: object

## props (required: `options`)
- `checkable?`: boolean
- `defaultExpandedKeys?`: string | DataBinding — array of keys of initially expanded nodes
- `defaultSelectedKeys?`: string | DataBinding — array of keys of initially selected nodes
