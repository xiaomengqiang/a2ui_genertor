...
> id: string | component: "TreeMapChart" | props: object

## props (required: `option`, `className`)
- `option`:
  - `data`: { `value`: string, `name`: string, `children?`: object[] }[] | DataBinding — Core chart data source (required)
