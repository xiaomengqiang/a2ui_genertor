# Checkbox
> id: string | component: "Checkbox" | props: object | children: object

## props
- `label?`: string | DataBinding — Used to set the label for the checkbox.
- `checked?`: boolean | DataBinding — Determines if the checkbox is checked.
